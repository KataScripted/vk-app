...
class AllExercise extends React.Component {
    ...
    render() {
        const findData = jsonExercises.find(item => item.id === this.state.id)
        return (
            <div style={{ padding: 10 }}>
                {findData.exercise.map(item => (
                    ...
                    <div
                        style={{
                            marginTop: 10, padding: 10, display: "flex", border: "1px solid silver",
                        ...
                        <div style={{
                            ...
                            <Button style={{
                                color: "white",
                                borderColor: "white"
                            }} mode="outline" onClick={() => this.changePanelNowNewExersice("exercise", item.id)}>Начать</Button>
                        </div>
